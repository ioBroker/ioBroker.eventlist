/**
 * The words of the eventlist blocks.
 *
 ...
 * moment at which the files could be fetched.
 */
...
const README = 'https://github.com/ioBroker/ioBroker.eventlist/blob/master/README.md';

/** Fills `Blockly.Words` with everything the eventlist blocks need */
export function installWords(): void {
    ...
    // allowed to be incomplete - `uk` and `zh-cn` only carry the words the adapter already had.
    ...
    // A link, not a word - it must not be handed to the translator
    Blockly.Words.eventlist_help = { en: `${README}#message-box` };
}
