/**
 * The ioBroker.eventlist blocks for the Blockly editor of ioBroker.javascript.
 *
 ...
 */
import { installDelete } from './blocks/delete';
import { installInsert } from './blocks/insert';
